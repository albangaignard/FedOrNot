 ...
 */
public class SPARK_CountPredictionsCluster_MultiNodes {

    public static Logger logger = Logger.getLogger(SPARK_CountPredictionsCluster_MultiNodes.class);

    public enum Headers {
        Filename, Single, Federated
    }

    public SPARK_CountPredictionsCluster_MultiNodes() {
    }
...
//        JavaRDD<String> data = sc.textFile("/Users/gaignard-a/Desktop/access.log-20150818.bz2");
                    ...
                    JavaRDD<String> queryPredictions = queries.filter(query -> {
...
//                                }
//                            });
                    long cntFed = queryPredictions.count();
                    System.out.println("FED QUERIES == " + cntFed);
                }
            }
            sw.stop();
