 ...
 */
public class SPARK_CountPredictionsCluster {

    public static Logger logger = Logger.getLogger(SPARK_CountPredictionsCluster.class);

    public enum Headers {
        Filename, Single, Federated
    }

    public SPARK_CountPredictionsCluster() {
    }
